...
const Condition: Template<TemplateRenderProps> = ({ document }) => {
    const {
        __meta,
        _site,
        name,
    ...
    const breadcrumbsData = [
        ...
        { id: "specialties", name: "Condition Treated", slug: "/specialties" },
        {
            id: slug || "unknown-specialty",
            name: name || "Condition Treated",
            slug: slug ? `/consitions/${slug}` : "#",
        },
    ];
    ...
    return (
        <PageLayout _site={_site} templateData={{ __meta, document }}>
            ...
            <section className="centered-container !py-4 hidden md:block">
